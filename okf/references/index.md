...
description: Docs, package index, and upstream references for OCCTSwiftAIS.
...
- **OpenCASCADE Technology (OCCT)** — the underlying B-Rep kernel reached transitively via OCCTSwift. <https://dev.opencascade.org/>
